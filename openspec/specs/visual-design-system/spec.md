...
## Purpose
Define the foundational design tokens, UI primitives, navigation shell, iconography, and responsive behavior that constitute the application's visual identity.
